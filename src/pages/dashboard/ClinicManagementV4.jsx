    ...
    <div style={{
      ...
      <div style={{ padding: '22px 18px 18px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            <p style={{ fontSize: 14, fontWeight: 800, color: '#0F172A', margin: 0, lineHeight: 1.15, fontFamily: 'Inter, system-ui, sans-serif', letterSpacing: '-0.02em' }}>
              Health Telematix
            </p>
            <p style={{ fontSize: 10.5, fontWeight: 500, color: '#94A3B8', margin: 0, fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div style={{ padding: '14px 12px', flex: 1 }}>
        <p style={{ fontSize: 10, fontWeight: 700, color: '#CBD5E1', textTransform: 'uppercase', letterSpacing: '0.1em', margin: '0 0 8px 12px', fontFamily: 'Inter, system-ui, sans-serif' }}>
          Main Menu
        </p>
      ...
      <div style={{ padding: '10px 12px 18px', borderTop: '1px solid #F1F5F9', display: 'flex', flexDirection: 'column', gap: 2 }}>
        <NavItem
        ...
        {/* User profile row with logout dropdown */}
        <div style={{ position: 'relative', marginTop: 6 }}>
          ...
          >
            <div style={{
              ...
              background: `linear-gradient(135deg, #14B8A6, ${TEAL})`,
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: 11, fontWeight: 700, color: 'white',
            }}>SM</div>
            <div style={{ flex: 1, textAlign: 'left', minWidth: 0 }}>
              <p style={{ fontSize: 12.5, fontWeight: 600, color: '#0F172A', margin: 0, lineHeight: 1.2, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                Dr. Sarah Mitchell
              </p>
...
function TopBar({ title, subtitle }) {
  return (
    <div style={{
      ...
      <div>
        <h1 style={{ fontSize: 17, fontWeight: 700, color: '#0F172A', margin: 0, fontFamily: 'Inter, system-ui, sans-serif', letterSpacing: '-0.01em' }}>
          {title}
        </h1>
        {subtitle && (
          <p style={{ fontSize: 12.5, color: '#94A3B8', margin: 0, fontFamily: 'Inter, system-ui, sans-serif' }}>{subtitle}</p>
        )}
      </div>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        <button style={{
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[560px] p-0 gap-0 overflow-hidden rounded-2xl">
        ...
        <DialogFooter className="px-7 py-4 border-t border-slate-100 flex-row justify-end gap-2">
          ...
          <Button onClick={onClose} className="rounded-[5px] h-9 px-5 text-sm gap-2" style={{ background: TEAL }}>
...
/* ─── Main Page ──────────────────────────────────────────────── */
export default function ClinicManagementV4() {
  const navigate = useNavigate()
  ...
  return (
    <div style={{ minHeight: '100vh', background: PAGE_BG, fontFamily: 'Inter, system-ui, sans-serif', display: 'flex' }}>
        ...
        <main style={{ padding: '28px 28px', flex: 1 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
                  ...
                  return (
                    ...
                    >
                      ...
                      <span style={{
                        ...
                        background: isActive ? TEAL : 'rgba(100,116,139,0.12)',
            ...
            <Button
              ...
              style={{ background: TEAL, boxShadow: `0 4px 14px ${TEAL}33` }}
            >
            ...
            <Table>
              ...
              <TableBody>
                {paginated.length > 0 ? paginated.map(clinic => (
                  <TableRow
                    key={clinic.id}
                    className="border-slate-100 hover:bg-teal-50/30 transition-colors cursor-pointer"
                  ...
                  >
                    ...
                    <TableCell className="py-4">
                      <span className="text-[13px] text-slate-500" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>{clinic.npi}</span>
                    </TableCell>

                    <TableCell className="py-4">
                      <span className="text-[13px] text-slate-500" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>{clinic.tin}</span>
                    </TableCell>
