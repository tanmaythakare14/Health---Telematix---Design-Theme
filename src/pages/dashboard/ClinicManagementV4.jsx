  ...
  return (
    <div style={{
      ...
      <div style={{ padding: collapsed ? '12px 8px 20px' : '12px 12px 20px', borderTop: '1px solid #F1F5F9', display: 'flex', flexDirection: 'column', gap: 6, flexShrink: 0 }}>
        <NavItem icon={<Settings size={17} />} label="Settings" active={activeItem === 'settings'} collapsed={collapsed} showTooltip={tooltip === 'settings'} />
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
        <h1 style={{ fontSize: 17, fontWeight: 700, color: '#0F172A', margin: 0, fontFamily: 'Inter, system-ui, sans-serif', letterSpacing: '-0.01em', lineHeight: 1.2 }}>
          {title}
        </h1>
        {subtitle && (
          <p style={{ fontSize: 12.5, color: '#94A3B8', margin: 0, fontFamily: 'Inter, system-ui, sans-serif', lineHeight: 1.3 }}>{subtitle}</p>
        )}
      </div>
...
export default function ClinicManagementV4() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: PAGE_BG, fontFamily: 'Inter, system-ui, sans-serif', display: 'flex' }}>
      ...
      <LeftNav active="clinic-management" collapsed={navCollapsed} onToggle={() => setNavCollapsed(o => !o)} />
