  ...
  return (
    <div style={{ flex: 1, background: '#ffffff', borderRadius: 14, border: '1px solid #E8EDF2', boxShadow: '0 1px 4px rgba(0,0,0,0.04)', padding: '22px 24px', display: 'flex', flexDirection: 'column', gap: 16 }}>
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12 }}>
        ...
        <div style={{ width: 40, height: 40, borderRadius: 10, flexShrink: 0, background: '#ffffff', border: '1px solid #E2E8F0', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#1F3A5F' }}>
          {icon}
        </div>
      </div>
