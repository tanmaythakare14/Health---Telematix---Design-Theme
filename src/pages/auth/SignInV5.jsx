...
function PanelIllustration() {
  return (
    <svg width="260" height="244" viewBox="0 0 340 320" fill="none">
      {/* Central monitor */}
      <rect x="100" y="80" width="140" height="100" rx="10" fill="rgba(255,255,255,0.10)" stroke="rgba(255,255,255,0.22)" strokeWidth="2"/>
      <rect x="112" y="92" width="116" height="76" rx="5" fill="rgba(255,255,255,0.07)"/>
      {/* EKG line */}
      <path d="M116 130 L132 130 L138 110 L146 150 L152 118 L158 130 L224 130"
            stroke="rgba(13,148,136,0.90)" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"/>
      <line x1="170" y1="180" x2="170" y2="210" stroke="rgba(255,255,255,0.18)" strokeWidth="3"/>
      <rect x="148" y="210" width="44" height="8" rx="4" fill="rgba(255,255,255,0.12)"/>

      {/* Left device */}
      <rect x="36" y="130" width="56" height="78" rx="10" fill="rgba(255,255,255,0.08)" stroke="rgba(255,255,255,0.18)" strokeWidth="1.8"/>
      <rect x="44" y="144" width="40" height="28" rx="5" fill="rgba(255,255,255,0.07)"/>
      <text x="64" y="163" textAnchor="middle" fill="rgba(255,255,255,0.80)" fontSize="12" fontWeight="700" fontFamily="Inter, sans-serif">120</text>
      <text x="64" y="175" textAnchor="middle" fill="rgba(255,255,255,0.45)" fontSize="8"  fontFamily="Inter, sans-serif">mmHg</text>
      <line x1="92" y1="165" x2="108" y2="153" stroke="rgba(255,255,255,0.12)" strokeWidth="1.5"/>

      {/* Right device */}
      <rect x="248" y="134" width="56" height="70" rx="10" fill="rgba(255,255,255,0.08)" stroke="rgba(255,255,255,0.18)" strokeWidth="1.8"/>
      <circle cx="276" cy="162" r="18" fill="rgba(255,255,255,0.05)" stroke="rgba(255,255,255,0.18)" strokeWidth="1.5"/>
      <text x="276" y="167" textAnchor="middle" fill="rgba(255,255,255,0.80)" fontSize="10" fontWeight="700" fontFamily="Inter, sans-serif">BMI</text>
      <line x1="248" y1="168" x2="232" y2="162" stroke="rgba(255,255,255,0.12)" strokeWidth="1.5"/>

      {/* Stat chips */}
      <rect x="68" y="232" width="74" height="30" rx="15" fill="rgba(13,148,136,0.20)" stroke="rgba(13,148,136,0.35)" strokeWidth="1.2"/>
      <text x="105" y="252" textAnchor="middle" fill="rgba(255,255,255,0.90)" fontSize="11" fontWeight="600" fontFamily="Inter, sans-serif">98 Patients</text>

      <rect x="152" y="232" width="60" height="30" rx="15" fill="rgba(255,255,255,0.10)" stroke="rgba(255,255,255,0.18)" strokeWidth="1.2"/>
      <text x="182" y="252" textAnchor="middle" fill="rgba(255,255,255,0.90)" fontSize="11" fontWeight="600" fontFamily="Inter, sans-serif">RPM ✓</text>

      <rect x="222" y="232" width="58" height="30" rx="15" fill="rgba(255,255,255,0.10)" stroke="rgba(255,255,255,0.18)" strokeWidth="1.2"/>
      <text x="251" y="252" textAnchor="middle" fill="rgba(255,255,255,0.90)" fontSize="11" fontWeight="600" fontFamily="Inter, sans-serif">APCM</text>

      {/* Sparkle dots */}
      <circle cx="56"  cy="82"  r="5" fill="rgba(13,148,136,0.40)"/>
      <circle cx="78"  cy="62"  r="3" fill="rgba(255,255,255,0.14)"/>
      <circle cx="282" cy="72"  r="4" fill="rgba(255,255,255,0.16)"/>
      <circle cx="306" cy="96"  r="3" fill="rgba(13,148,136,0.30)"/>
      <circle cx="44"  cy="280" r="4" fill="rgba(255,255,255,0.10)"/>
      <circle cx="296" cy="288" r="5" fill="rgba(13,148,136,0.25)"/>

      <path d="M92 170 C100 170 100 170 108 160" stroke="rgba(255,255,255,0.10)" strokeWidth="1" strokeDasharray="3 3"/>
      <path d="M248 162 C240 162 240 162 232 162" stroke="rgba(255,255,255,0.10)" strokeWidth="1" strokeDasharray="3 3"/>
    </svg>
  )
}
...
export default function SignInV5() {
  ...
  return (
    ...
    >
      {/* ── LEFT — Navy illustration panel (navbar color) ── */}
      <div
        style={{
          flex: 1,
          minHeight: '100vh',
          background: 'linear-gradient(160deg, #1F3A5F 0%, #162d4a 55%, #0f2035 100%)',
          display: 'flex',
      ...
      >
        ...
        <div style={{
          ...
          height: 3,
          background: 'linear-gradient(90deg, #1F3A5F, #0D9488)',
          pointerEvents: 'none',
        }} />
      ...
      >
        ...
        <div style={{ width: '100%', maxWidth: 400 }}>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <button
              ...
              style={{
                ...
                background: loading
                  ? 'rgba(31,58,95,0.55)'
                  : 'linear-gradient(135deg, #1F3A5F 0%, #0D9488 100%)',
                border: 'none',
                borderRadius: 12,
                color: 'white',
                fontSize: 15,
                ...
                boxShadow: loading ? 'none' : '0 4px 20px rgba(31,58,95,0.30)',
              ...
              onMouseEnter={e => {
                if (!loading) e.currentTarget.style.boxShadow = '0 6px 28px rgba(13,148,136,0.35)'
              }}
              onMouseLeave={e => {
                if (!loading) e.currentTarget.style.boxShadow = '0 4px 20px rgba(31,58,95,0.30)'
              }}
            >
              {loading ? (
                <>
          ...
          <p style={{ marginTop: 24, fontSize: 12, color: '#9CA3AF', textAlign: 'center', lineHeight: 1.6 }}>
            ...
            <a href="#" style={{ color: '#1F3A5F', textDecoration: 'none', fontWeight: 500 }}>Privacy Policy</a>
            {' '}&amp;{' '}
